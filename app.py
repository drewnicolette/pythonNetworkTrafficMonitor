...
pusher = Pusher(app_id=u'967377', key=u'9003f57c23cf7feef805', secret=u'a19f0e5c5c7bb0f7a760', cluster=u'us2')
...
def getAnalyticsData():
    ...
    userIP = "192.168.1.39" if request.remote_addr == '127.0.0.1' else request.remote_addr
